...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {toast && (
        <div style={{ position:"fixed",top:20,left:"50%",transform:"translateX(-50%)",zIndex:9999,background:dark?"#1e3048":"#0f172a",color:"#fff",padding:"10px 20px",borderRadius:999,fontSize:13,fontWeight:600,display:"flex",alignItems:"center",gap:8,boxShadow:"0 8px 32px rgba(0,0,0,0.3)",animation:"scaleIn 0.2s ease",whiteSpace:"nowrap" }}>
      ...
      <header style={{ position:"sticky",top:0,zIndex:500,background:T.header,backdropFilter:"blur(20px)",WebkitBackdropFilter:"blur(20px)",borderBottom:"1px solid "+T.border,boxShadow:dark?"0 4px 24px rgba(0,0,0,0.4)":"0 2px 12px rgba(0,0,0,0.06)" }}>
        <div style={{ maxWidth:1200,margin:"0 auto",padding:"8px 12px 0" }}>

          <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8 }}>
            <div style={{ display:"flex",alignItems:"center",gap:8 }}>
              <span style={{fontSize:24}}>🌍</span>
              <div>
                <div style={{ fontWeight:800,fontSize:16,background:"linear-gradient(90deg,#f97316,#ef4444)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",lineHeight:1.1 }}>WorldWire</div>
          ...
          {showSearch && (
            <form onSubmit={handleSearchSubmit} style={{ marginBottom:8,animation:"fadeUp 0.2s ease" }} onClick={function(e){e.stopPropagation();}}>
